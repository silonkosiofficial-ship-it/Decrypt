...
public abstract class M {
    ...
    public java.lang.Object[] f53312b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public float[] f53313c;
    ...
    private M() {
        this.f53311a = p170r.V.f53338a;
        this.f53312b = p180s.a.f54038c;
        this.f53313c = p170r.AbstractC7034i.a();
    }

    public /* synthetic */ M(p247y7.AbstractC7342k abstractC7342k) {
        this();
    }
    ...
    public final float c(java.lang.Object obj) {
        int iB = b(obj);
        if (iB >= 0) {
            return this.f53313c[iB];
        }
    ...
    public final float e(java.lang.Object obj, float f6) {
        int iB = b(obj);
        return iB >= 0 ? this.f53313c[iB] : f6;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof p170r.M)) {
            return false;
        }
        p170r.M m6 = (p170r.M) obj;
        if (m6.f() != f()) {
            return false;
        }
                ...
                if ((((~j6) << 7) & j6 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j6) < 128) {
                            ...
                            iFloatToIntBits += java.lang.Float.floatToIntBits(fArr[i13]) ^ (obj != null ? obj.hashCode() : 0);
                        }
                        j6 >>= 8;
                    }
                    if (i11 != 8) {
