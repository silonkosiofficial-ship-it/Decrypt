...
final class D3 extends com.google.android.gms.internal.play_billing.F3 {
    D3(sun.misc.Unsafe unsafe) {
        super(unsafe);
    }
    ...
    public final void c(java.lang.Object obj, long j6, boolean z6) {
        if (com.google.android.gms.internal.play_billing.G3.f41409h) {
            com.google.android.gms.internal.play_billing.G3.d(obj, j6, z6 ? (byte) 1 : (byte) 0);
        } else {
            com.google.android.gms.internal.play_billing.G3.e(obj, j6, z6 ? (byte) 1 : (byte) 0);
        }
    }
