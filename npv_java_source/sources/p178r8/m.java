...
public final class m implements G8.b {
    ...
    private final java.util.Map f54027a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final G8.e.a f54028b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final G8.g f54029c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final G8.f f54030d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final p237x7.p f54031e;

    public static final class a extends F8.d0 {

        /* JADX INFO: renamed from: k, reason: collision with root package name */
        final /* synthetic */ p178r8.m f54032k;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(boolean z6, boolean z10, p178r8.m mVar, G8.f fVar, G8.g gVar) {
            super(z6, z10, true, mVar, fVar, gVar);
            this.f54032k = mVar;
        }
        ...
        public boolean f(J8.i iVar, J8.i iVar2) {
            ...
            if (iVar2 instanceof F8.E) {
                return ((java.lang.Boolean) this.f54032k.f54031e.u(iVar, iVar2)).booleanValue();
            }
            throw new java.lang.IllegalArgumentException("Failed requirement.".toString());
        }
    }

    public m(java.util.Map map, G8.e.a aVar, G8.g gVar, G8.f fVar, p237x7.p pVar) {
        p247y7.AbstractC7350t.f(aVar, "equalityAxioms");
    ...
    private final boolean G0(F8.e0 e0Var, F8.e0 e0Var2) {
        if (this.f54028b.a(e0Var, e0Var2)) {
            return true;
        }
        java.util.Map map = this.f54027a;
        if (map == null) {
            return false;
        }
        F8.e0 e0Var3 = (F8.e0) map.get(e0Var);
        F8.e0 e0Var4 = (F8.e0) this.f54027a.get(e0Var2);
        if (e0Var3 == null || !p247y7.AbstractC7350t.b(e0Var3, e0Var2)) {
            return e0Var4 != null && p247y7.AbstractC7350t.b(e0Var4, e0Var);
        }
        return true;
    }
    ...
    public F8.d0 H0(boolean z6, boolean z10) {
        if (this.f54031e != null) {
            return new r8.m.a(z6, z10, this, this.f54030d, this.f54029c);
        }
        return G8.a.a(z6, z10, this, this.f54030d, this.f54029c);
    }
    ...
    public boolean h0(J8.m mVar, J8.m mVar2) {
        ...
        if (mVar2 instanceof F8.e0) {
            return G8.b.a.a(this, mVar, mVar2) || G0((F8.e0) mVar, (F8.e0) mVar2);
        }
        throw new java.lang.IllegalArgumentException("Failed requirement.".toString());
    }
