...
public abstract class D {
    ...
    private static p201u0.d f8704a;

    public static final p201u0.d a(O.b.a aVar) {
        p201u0.d dVar = f8704a;
        if (dVar != null) {
            p247y7.AbstractC7350t.c(dVar);
            return dVar;
        }
        u0.d.a aVar2 = new u0.d.a("Filled.PrivacyTip", Y0.i.q(24.0f), Y0.i.q(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        int iB = p201u0.o.b();
        ...
        fVar.h(3.0f, 5.0f);
        fVar.o(6.0f);
        fVar.d(0.0f, 5.55f, 3.84f, 10.74f, 9.0f, 12.0f);
        fVar.d(5.16f, -1.26f, 9.0f, -6.45f, 9.0f, -12.0f);
        fVar.n(5.0f);
        fVar.h(12.0f, 1.0f);
        fVar.h(12.0f, 1.0f);
        fVar.b();
