...
public class C1915v extends android.widget.RadioButton implements androidx.core.widget.j, androidx.core.widget.k {

    /* JADX INFO: renamed from: C, reason: collision with root package name */
    private final androidx.appcompat.widget.C1904j f18580C;

    /* JADX INFO: renamed from: D, reason: collision with root package name */
    private final androidx.appcompat.widget.C1899e f18581D;

    /* JADX INFO: renamed from: E, reason: collision with root package name */
    private final androidx.appcompat.widget.C f18582E;

    /* JADX INFO: renamed from: F, reason: collision with root package name */
    private androidx.appcompat.widget.C1908n f18583F;

    public C1915v(android.content.Context context, android.util.AttributeSet attributeSet) {
        this(context, attributeSet, p090j.a.f48616D);
    }

    public C1915v(android.content.Context context, android.util.AttributeSet attributeSet, int i6) {
    ...
    private androidx.appcompat.widget.C1908n getEmojiTextViewHelper() {
        if (this.f18583F == null) {
            this.f18583F = new androidx.appcompat.widget.C1908n(this);
        }
        return this.f18583F;
    }
    ...
    protected void drawableStateChanged() {
        ...
        androidx.appcompat.widget.C1899e c1899e = this.f18581D;
        if (c1899e != null) {
            c1899e.b();
        }
        androidx.appcompat.widget.C c6 = this.f18582E;
        if (c6 != null) {
            c6.b();
        }
    }
    ...
    public int getCompoundPaddingLeft() {
        ...
        androidx.appcompat.widget.C1904j c1904j = this.f18580C;
    ...
    public android.content.res.ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f18582E.j();
    }

    public android.graphics.PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f18582E.k();
    }
