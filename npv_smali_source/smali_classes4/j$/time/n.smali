...
.method static a(Ljava/io/ObjectInput;)Ljava/io/Serializable;
    ...
    invoke-static {v0, p0}, Lj$/time/n;->b(BLjava/io/ObjectInput;)Ljava/io/Serializable;
...
.method private static b(BLjava/io/ObjectInput;)Ljava/io/Serializable;
    ...
    :pswitch_0
    invoke-static {p1}, Lj$/time/m;->c(Ljava/io/DataInput;)Lj$/time/m;
    ...
    :pswitch_2
    invoke-static {p1}, Lj$/time/r;->Q(Ljava/io/DataInput;)Lj$/time/r;
    ...
    :pswitch_3
    sget p0, Lj$/time/p;->b:I

    invoke-interface {p1}, Ljava/io/DataInput;->readInt()I

    move-result p0

    invoke-static {p0}, Lj$/time/p;->M(I)Lj$/time/p;
    ...
    :pswitch_5
    invoke-static {p1}, Lj$/time/l;->O(Ljava/io/ObjectInput;)Lj$/time/l;
    ...
    invoke-static {p1}, Lj$/time/LocalTime;->X(Ljava/io/DataInput;)Lj$/time/LocalTime;
    ...
    invoke-static {v0, v1, p0, p1}, Lj$/time/Duration;->y(JJ)Lj$/time/Duration;
...
.method public final readExternal(Ljava/io/ObjectInput;)V
    ...
    invoke-static {v0, p1}, Lj$/time/n;->b(BLjava/io/ObjectInput;)Ljava/io/Serializable;
...
.method public final writeExternal(Ljava/io/ObjectOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/m;->e(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/j;->N(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/r;->T(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/p;->Q(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/l;->writeExternal(Ljava/io/ObjectOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/s;->R(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/LocalDateTime;->c0(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {v1, p1}, Lj$/time/LocalDate;->h0(Ljava/io/DataOutput;)V
