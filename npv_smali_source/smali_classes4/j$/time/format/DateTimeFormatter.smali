...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v0, v6, v7}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    invoke-virtual {v0, v5}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    sget-object v8, Lj$/time/temporal/a;->DAY_OF_MONTH:Lj$/time/temporal/a;

    invoke-virtual {v0, v8, v7}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    sget-object v9, Lj$/time/format/C;->STRICT:Lj$/time/format/C;

    sget-object v10, Lj$/time/chrono/q;->e:Lj$/time/chrono/q;

    invoke-virtual {v0, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v11, v12, v7}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v11, v14, v7}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v11, v15, v7}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v11, v13, v7, v5, v3}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/s;IIZ)V

    const/4 v5, 0x0

    invoke-virtual {v11, v9, v5}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v7, v9, v10}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v1, v7, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/s;IILj$/time/format/D;)V
    ...
    invoke-virtual {v0, v7, v11}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v0, v7, v11, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/s;IILj$/time/format/D;)V
    ...
    invoke-virtual {v0, v2, v4}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v0, v9, v5}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, v1, v4}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    const/4 v4, 0x2

    invoke-virtual {v0, v6, v4}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    invoke-virtual {v0, v8, v4}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v3, v2, v0}, Lj$/time/format/DateTimeFormatterBuilder;->j(Lj$/time/temporal/s;Ljava/util/HashMap;)V
    ...
    invoke-virtual {v3, v8, v4, v2, v0}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/s;IILj$/time/format/D;)V

    const/16 v0, 0x20

    invoke-virtual {v3, v0}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    invoke-virtual {v3, v6, v10}, Lj$/time/format/DateTimeFormatterBuilder;->j(Lj$/time/temporal/s;Ljava/util/HashMap;)V

    invoke-virtual {v3, v0}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    const/4 v4, 0x4

    invoke-virtual {v3, v1, v4}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    invoke-virtual {v3, v0}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    invoke-virtual {v3, v12, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    const/16 v1, 0x3a

    invoke-virtual {v3, v1}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    invoke-virtual {v3, v14, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v3, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    sget-object v1, Lj$/time/format/C;->SMART:Lj$/time/format/C;

    move-object/from16 v2, v16

    invoke-virtual {v0, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->u(Lj$/time/format/C;Lj$/time/chrono/Chronology;)Lj$/time/format/DateTimeFormatter;
...
.method constructor <init>(Lj$/time/format/e;Ljava/util/Locale;Lj$/time/format/DecimalStyle;Lj$/time/format/C;Lj$/time/chrono/Chronology;)V
    ...
    check-cast p2, Lj$/time/format/DecimalStyle;

    iput-object p2, p0, Lj$/time/format/DateTimeFormatter;->c:Lj$/time/format/DecimalStyle;

    const-string p2, "resolverStyle"

    invoke-static {p4, p2}, Lj$/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lj$/time/format/C;

    iput-object p2, p0, Lj$/time/format/DateTimeFormatter;->d:Lj$/time/format/C;
...
.method private f(Ljava/lang/CharSequence;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {v4, v2, p1, v3}, Lj$/time/format/e;->p(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v2, p1, v0}, Lj$/time/format/v;->t(Lj$/time/format/C;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
...
.method public static ofPattern(Ljava/lang/String;Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
    ...
    invoke-virtual {v0, p1}, Lj$/time/format/DateTimeFormatterBuilder;->v(Ljava/util/Locale;)Lj$/time/format/DateTimeFormatter;
...
.method public final a(Lj$/time/temporal/TemporalAccessor;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {p1, v1, v0}, Lj$/time/format/e;->n(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    :try_end_1
...
.method public parse(Ljava/lang/CharSequence;Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2}, Lj$/time/format/B;->x(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
