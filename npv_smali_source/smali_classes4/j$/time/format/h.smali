...
.method public final n(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/x;->e(Lj$/time/temporal/s;)Ljava/lang/Long;
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->e(Lj$/time/temporal/s;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->u(Lj$/time/temporal/s;)J
    ...
    invoke-static {v5, v6, v3, v2}, Lj$/time/LocalDateTime;->T(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v12, v13, v3, v2}, Lj$/time/LocalDateTime;->T(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public final p(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V

    invoke-virtual {v0, v3}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    sget-object v3, Lj$/time/temporal/a;->SECOND_OF_MINUTE:Lj$/time/temporal/a;

    invoke-virtual {v0, v3, v2}, Lj$/time/format/DateTimeFormatterBuilder;->m(Lj$/time/temporal/s;I)V
    ...
    invoke-virtual {v0, v7, v2, v5, v8}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/s;IIZ)V
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/e;->p(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v5, v0}, Lj$/time/format/v;->j(Lj$/time/temporal/s;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v1}, Lj$/time/format/v;->j(Lj$/time/temporal/s;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v4}, Lj$/time/format/v;->j(Lj$/time/temporal/s;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v3}, Lj$/time/format/v;->j(Lj$/time/temporal/s;)Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v5, v7}, Lj$/time/format/v;->j(Lj$/time/temporal/s;)Ljava/lang/Long;
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/LocalDateTime;->V(J)Lj$/time/LocalDateTime;
