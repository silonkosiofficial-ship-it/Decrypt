...
# direct methods
.method constructor <init>(Lj$/time/temporal/s;IIZ)V
    .locals 6
    ...
    invoke-static {p3, p1}, Lj$/time/b;->a(Ljava/lang/String;Lj$/time/temporal/s;)Ljava/lang/String;
...
.method public final n(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/s;->n()Lj$/time/temporal/v;

    move-result-object v1

    invoke-virtual {v1, v3, v4, v0}, Lj$/time/temporal/v;->b(JLj$/time/temporal/s;)V
...
.method public final p(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-interface {p3}, Lj$/time/temporal/s;->n()Lj$/time/temporal/v;
    ...
    invoke-virtual/range {v4 .. v9}, Lj$/time/format/v;->o(Lj$/time/temporal/s;JII)I
