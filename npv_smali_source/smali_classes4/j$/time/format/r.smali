...
# direct methods
.method constructor <init>(Lj$/time/temporal/s;Lj$/time/format/TextStyle;Lj$/time/format/A;)V
    .locals 0
...
.method public final n(Lj$/time/format/x;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/TemporalAccessor;->x(Lj$/time/temporal/TemporalQuery;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v2 .. v8}, Lj$/time/format/A;->d(Lj$/time/chrono/Chronology;Lj$/time/temporal/s;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/A;->e(Lj$/time/temporal/s;JLj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1, v3, v4}, Lj$/time/format/j;-><init>(Lj$/time/temporal/s;IILj$/time/format/D;)V
...
.method public final p(Lj$/time/format/v;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v2, v1, v3, v0, v4}, Lj$/time/format/A;->f(Lj$/time/chrono/Chronology;Lj$/time/temporal/s;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual {v2, v3, v0, v4}, Lj$/time/format/A;->g(Lj$/time/temporal/s;Lj$/time/format/TextStyle;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    invoke-virtual/range {v5 .. v10}, Lj$/time/format/v;->o(Lj$/time/temporal/s;JII)I
    ...
    invoke-interface {v1}, Lj$/time/chrono/Chronology;->H()Ljava/util/List;
    ...
    invoke-interface {v1}, Lj$/time/chrono/k;->getValue()I
    ...
    invoke-direct {v0, v1, v3, v4, v2}, Lj$/time/format/j;-><init>(Lj$/time/temporal/s;IILj$/time/format/D;)V
