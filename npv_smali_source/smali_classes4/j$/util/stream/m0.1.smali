...
.method public static synthetic w(Lj$/util/stream/n0;)Ljava/util/stream/LongStream;
    .locals 1
...
.method public final synthetic anyMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->s()Z
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->average()Lj$/util/z;
...
.method public final synthetic distinct()Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/m0;->w(Lj$/util/stream/n0;)Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findAny()Lj$/util/B;

    move-result-object v0

    invoke-static {v0}, Lj$/util/Q;->p(Lj$/util/B;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->findFirst()Lj$/util/B;
...
.method public final flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, v1}, Lj$/util/stream/n0;->b(Lj$/util/stream/a;)Lj$/util/stream/n0;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->iterator()Lj$/util/N;

    move-result-object v0

    invoke-static {v0}, Lj$/util/M;->a(Lj$/util/N;)Ljava/util/PrimitiveIterator$OfLong;
...
.method public final synthetic mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->h()Lj$/util/stream/F;
...
.method public final synthetic mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->t()Lj$/util/stream/IntStream;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->max()Lj$/util/B;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->min()Lj$/util/B;
...
.method public final synthetic noneMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {p1}, Lj$/util/stream/n0;->j()Z
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/n0;->reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/B;

    move-result-object p1

    invoke-static {p1}, Lj$/util/Q;->p(Lj$/util/B;)Ljava/util/OptionalLong;
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/n0;->summaryStatistics()Lj$/util/y;
