...
.method final K(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/K0;
    ...
    invoke-virtual {p1}, Lj$/util/stream/b;->F()Lj$/util/stream/g3;
    ...
    invoke-static/range {v6 .. v11}, Lj$/util/stream/y0;->C(Lj$/util/stream/g3;Lj$/util/Spliterator;JJ)Lj$/util/Spliterator;

    move-result-object p2

    invoke-static {p1, p2, v5}, Lj$/util/stream/y0;->F(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/E0;
    ...
    invoke-virtual {v4, v6}, Lj$/util/stream/f3;->u(I)Z
    ...
    iget-wide v8, p0, Lj$/util/stream/y2;->n:J
    ...
    invoke-static {p0, p1, v5}, Lj$/util/stream/y0;->F(Lj$/util/stream/b;Lj$/util/Spliterator;Z)Lj$/util/stream/E0;
...
.method final L(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget-wide v5, v9, Lj$/util/stream/y2;->n:J
    ...
    invoke-static {v12, v13, v5, v6}, Lj$/util/stream/y0;->B(JJ)J

    move-result-wide v14

    move-object v10, v0

    invoke-direct/range {v10 .. v15}, Lj$/util/stream/y3;-><init>(Lj$/util/d0;JJ)V
    ...
    invoke-virtual {v4, v8}, Lj$/util/stream/f3;->u(I)Z
    ...
    iget-wide v7, v9, Lj$/util/stream/y2;->m:J
