...
.method constructor <init>(Lj$/util/stream/S3;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/S3;->h:Lj$/util/stream/b;

    iput-object p2, p0, Lj$/util/stream/S3;->h:Lj$/util/stream/b;

    iget-object p2, p1, Lj$/util/stream/S3;->i:Ljava/util/function/IntFunction;

    iput-object p2, p0, Lj$/util/stream/S3;->i:Ljava/util/function/IntFunction;

    iget-boolean p1, p1, Lj$/util/stream/S3;->j:Z

    iput-boolean p1, p0, Lj$/util/stream/S3;->j:Z
...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    iput-object p1, p0, Lj$/util/stream/S3;->h:Lj$/util/stream/b;

    iput-object p4, p0, Lj$/util/stream/S3;->i:Ljava/util/function/IntFunction;
    ...
    invoke-virtual {p1, p2}, Lj$/util/stream/f3;->u(I)Z
...
.method protected final a()Ljava/lang/Object;
    ...
    iget-boolean v2, p0, Lj$/util/stream/S3;->j:Z

    if-eqz v2, :cond_0

    sget-object v2, Lj$/util/stream/f3;->SIZED:Lj$/util/stream/f3;

    iget-object v3, p0, Lj$/util/stream/S3;->h:Lj$/util/stream/b;

    iget v3, v3, Lj$/util/stream/b;->c:I

    invoke-virtual {v2, v3}, Lj$/util/stream/f3;->x(I)Z

    move-result v2

    if-eqz v2, :cond_0

    iget-object v2, p0, Lj$/util/stream/S3;->h:Lj$/util/stream/b;
    ...
    iget-object v5, p0, Lj$/util/stream/S3;->i:Ljava/util/function/IntFunction;

    invoke-virtual {v4, v2, v3, v5}, Lj$/util/stream/b;->J(JLjava/util/function/IntFunction;)Lj$/util/stream/C0;
    ...
    iget-boolean v4, p0, Lj$/util/stream/S3;->j:Z
    ...
    invoke-direct {v0, v3, v2, v1}, Lj$/util/stream/Q3;-><init>(Lj$/util/stream/R3;Lj$/util/stream/q2;Z)V
    ...
    invoke-interface {v2}, Lj$/util/stream/C0;->a()Lj$/util/stream/K0;
    ...
    iput-wide v2, p0, Lj$/util/stream/S3;->k:J

    iget-wide v2, v0, Lj$/util/stream/Q3;->b:J

    iput-wide v2, p0, Lj$/util/stream/S3;->l:J
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    :cond_0
    iget-boolean v1, p0, Lj$/util/stream/S3;->j:Z
    ...
    iget-wide v2, v1, Lj$/util/stream/S3;->l:J

    iput-wide v2, p0, Lj$/util/stream/S3;->l:J

    iget-wide v4, v1, Lj$/util/stream/S3;->k:J
    ...
    iget-wide v1, v0, Lj$/util/stream/S3;->k:J

    iget-object v3, p0, Lj$/util/stream/e;->e:Lj$/util/stream/e;

    check-cast v3, Lj$/util/stream/S3;

    iget-wide v4, v3, Lj$/util/stream/S3;->k:J

    add-long/2addr v1, v4

    iput-wide v1, p0, Lj$/util/stream/S3;->k:J
    ...
    :cond_2
    iget-wide v1, v3, Lj$/util/stream/S3;->k:J
    ...
    :cond_3
    iget-object v0, p0, Lj$/util/stream/S3;->h:Lj$/util/stream/b;
    ...
    invoke-static {v0, v1, v2}, Lj$/util/stream/y0;->I(Lj$/util/stream/g3;Lj$/util/stream/K0;Lj$/util/stream/K0;)Lj$/util/stream/M0;
    ...
    iget-boolean v0, p0, Lj$/util/stream/S3;->j:Z

    if-eqz v0, :cond_4

    iget-wide v2, p0, Lj$/util/stream/S3;->l:J

    invoke-interface {v1}, Lj$/util/stream/K0;->count()J

    move-result-wide v4

    iget-object v6, p0, Lj$/util/stream/S3;->i:Ljava/util/function/IntFunction;

    invoke-interface/range {v1 .. v6}, Lj$/util/stream/K0;->g(JJLjava/util/function/IntFunction;)Lj$/util/stream/K0;
