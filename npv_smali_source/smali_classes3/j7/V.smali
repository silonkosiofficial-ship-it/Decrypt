...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lj7/T;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Li7/u;)Ljava/util/HashMap;
    .locals 2
    ...
    invoke-static {v0, p0}, Lj7/V;->p(Ljava/util/Map;[Li7/u;)V

    return-object v0
.end method

.method public static varargs k([Li7/u;)Ljava/util/Map;
    .locals 2
    ...
    invoke-static {p0, v0}, Lj7/V;->t([Li7/u;Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs l([Li7/u;)Ljava/util/Map;
    .locals 2
...
.method public static final m(Ljava/util/Map;)Ljava/util/Map;
    ...
    :cond_0
    invoke-static {p0}, Lj7/U;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final p(Ljava/util/Map;[Li7/u;)V
    .locals 4
...
.method public static q(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lj7/V;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_1
    invoke-static {p0}, Lj7/S;->e(Li7/u;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lj7/V;->r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lj7/V;->m(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final r(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lj7/V;->o(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static s(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lj7/S;->u(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final t([Li7/u;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {p1, p0}, Lj7/V;->p(Ljava/util/Map;[Li7/u;)V
