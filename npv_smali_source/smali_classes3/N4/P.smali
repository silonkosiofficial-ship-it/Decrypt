...
.method public static b(Ljava/util/Comparator;Ljava/lang/Iterable;)Z
    ...
    invoke-static {p1}, LN4/P;->a(Ljava/util/SortedSet;)Ljava/util/Comparator;
    ...
    :cond_0
    instance-of v0, p1, LN4/O;

    if-eqz v0, :cond_1

    check-cast p1, LN4/O;

    invoke-interface {p1}, LN4/O;->comparator()Ljava/util/Comparator;
