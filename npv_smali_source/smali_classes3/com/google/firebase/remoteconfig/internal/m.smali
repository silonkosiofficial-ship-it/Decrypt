...
.method public constructor <init>(LG5/e;LF5/b;Ljava/util/concurrent/Executor;LV3/f;Ljava/util/Random;Lcom/google/firebase/remoteconfig/internal/f;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lcom/google/firebase/remoteconfig/internal/p;Ljava/util/Map;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/m;->a:LG5/e;

    iput-object p2, p0, Lcom/google/firebase/remoteconfig/internal/m;->b:LF5/b;

    iput-object p3, p0, Lcom/google/firebase/remoteconfig/internal/m;->c:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lcom/google/firebase/remoteconfig/internal/m;->d:LV3/f;
...
.method private B(Ljava/util/Date;)V
    ...
    invoke-virtual {p1, v0, v3}, Lcom/google/firebase/remoteconfig/internal/p;->j(ILjava/util/Date;)V

    return-void
.end method

.method private C(Ll4/l;Ljava/util/Date;)V
    .locals 1
...
.method public static synthetic a(Lcom/google/firebase/remoteconfig/internal/m;Ll4/l;Ll4/l;Ljava/util/Date;Ljava/util/Map;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/google/firebase/remoteconfig/internal/m;->w(Ll4/l;Ll4/l;Ljava/util/Date;Ljava/util/Map;Ll4/l;)Ll4/l;
...
.method public static synthetic b(Lcom/google/firebase/remoteconfig/internal/m$a;Lcom/google/firebase/remoteconfig/internal/g;)Ll4/l;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/remoteconfig/internal/m;->v(Lcom/google/firebase/remoteconfig/internal/m$a;Lcom/google/firebase/remoteconfig/internal/g;)Ll4/l;
...
.method public static synthetic c(Lcom/google/firebase/remoteconfig/internal/m;Ljava/util/Date;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/remoteconfig/internal/m;->x(Ljava/util/Date;Ll4/l;)Ll4/l;
...
.method public static synthetic d(Lcom/google/firebase/remoteconfig/internal/m;Ljava/util/Map;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/remoteconfig/internal/m;->y(Ljava/util/Map;Ll4/l;)Ll4/l;
...
.method public static synthetic e(Lcom/google/firebase/remoteconfig/internal/m;JLjava/util/Map;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/m;->u(JLjava/util/Map;Ll4/l;)Ll4/l;
...
.method private f(JLjava/util/Date;)Z
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/p;->d()Ljava/util/Date;
...
.method private g(LN5/m;)LN5/m;
    .locals 5

    .prologue
    invoke-virtual {p1}, LN5/m;->a()I
    ...
    invoke-direct {p1, v0}, LN5/j;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v0, p1}, LN5/m;-><init>(ILjava/lang/String;Ljava/lang/Throwable;)V
...
.method private k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Map;)Lcom/google/firebase/remoteconfig/internal/m$a;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/p;->c()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/google/firebase/remoteconfig/internal/p;->h()V
    :try_end_0
    .catch LN5/m; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {p1, p2, p3}, LN5/l;-><init>(J)V

    throw p1

    :cond_2
    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/internal/m;->g(LN5/m;)LN5/m;
...
.method private l(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Map;)Ll4/l;
    .locals 0
    ...
    invoke-virtual {p2, p3}, Lcom/google/firebase/remoteconfig/internal/f;->k(Lcom/google/firebase/remoteconfig/internal/g;)Ll4/l;
    ...
    invoke-virtual {p2, p3, p4}, Ll4/l;->p(Ljava/util/concurrent/Executor;Ll4/k;)Ll4/l;
...
.method private m(Ll4/l;JLjava/util/Map;)Ll4/l;
    .locals 8
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/m;->d:LV3/f;
    ...
    invoke-direct {p2, p3, v0, v1}, LN5/l;-><init>(Ljava/lang/String;J)V

    invoke-static {p2}, Ll4/o;->d(Ljava/lang/Exception;)Ll4/l;
    ...
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/m;->a:LG5/e;

    invoke-interface {p1}, LG5/e;->a()Ll4/l;

    move-result-object v3

    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/m;->a:LG5/e;

    invoke-interface {p1, v0}, LG5/e;->b(Z)Ll4/l;

    move-result-object v4

    const/4 p1, 0x2

    new-array p1, p1, [Ll4/l;
    ...
    invoke-static {p1}, Ll4/o;->j([Ll4/l;)Ll4/l;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/firebase/remoteconfig/internal/j;-><init>(Lcom/google/firebase/remoteconfig/internal/m;Ll4/l;Ll4/l;Ljava/util/Date;Ljava/util/Map;)V

    invoke-virtual {p1, p2, p3}, Ll4/l;->i(Ljava/util/concurrent/Executor;Ll4/c;)Ll4/l;
    ...
    invoke-direct {p3, p0, v7}, Lcom/google/firebase/remoteconfig/internal/k;-><init>(Lcom/google/firebase/remoteconfig/internal/m;Ljava/util/Date;)V
...
.method private p()Ljava/lang/Long;
    ...
    .prologue
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/m;->b:LF5/b;
    ...
    invoke-interface {v0, v1}, LT4/a;->b(Z)Ljava/util/Map;
...
.method private s()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/m;->b:LF5/b;

    invoke-interface {v1}, LF5/b;->get()Ljava/lang/Object;
    ...
    invoke-interface {v1, v2}, LT4/a;->b(Z)Ljava/util/Map;
...
.method private synthetic u(JLjava/util/Map;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct {p0, p4, p1, p2, p3}, Lcom/google/firebase/remoteconfig/internal/m;->m(Ll4/l;JLjava/util/Map;)Ll4/l;
...
.method private static synthetic v(Lcom/google/firebase/remoteconfig/internal/m$a;Lcom/google/firebase/remoteconfig/internal/g;)Ll4/l;
    .locals 0
...
.method private synthetic w(Ll4/l;Ll4/l;Ljava/util/Date;Ljava/util/Map;Ll4/l;)Ll4/l;
    .locals 0
    ...
    invoke-direct {p2, p3, p1}, LN5/j;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p2}, Ll4/l;->k()Ljava/lang/Exception;

    move-result-object p2

    invoke-direct {p1, p3, p2}, LN5/j;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/m;->l(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Map;)Ll4/l;
...
.method private synthetic x(Ljava/util/Date;Ll4/l;)Ll4/l;
    .locals 0

    invoke-direct {p0, p2, p1}, Lcom/google/firebase/remoteconfig/internal/m;->C(Ll4/l;Ljava/util/Date;)V

    return-object p2
.end method

.method private synthetic y(Ljava/util/Map;Ll4/l;)Ll4/l;
    .locals 2

    const-wide/16 v0, 0x0

    invoke-direct {p0, p2, v0, v1, p1}, Lcom/google/firebase/remoteconfig/internal/m;->m(Ll4/l;JLjava/util/Map;)Ll4/l;
...
.method public i()Ll4/l;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/firebase/remoteconfig/internal/m;->j(J)Ll4/l;
...
.method public j(J)Ll4/l;
    ...
    sget-object v2, Lcom/google/firebase/remoteconfig/internal/m$b;->D:Lcom/google/firebase/remoteconfig/internal/m$b;
...
.method public n(Lcom/google/firebase/remoteconfig/internal/m$b;I)Ll4/l;
    .locals 2
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/f;->e()Ll4/l;
    ...
    invoke-virtual {p1, p2, v1}, Ll4/l;->i(Ljava/util/concurrent/Executor;Ll4/c;)Ll4/l;
...
.method public r()J
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/p;->e()J
