...
# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Lcom/google/firebase/remoteconfig/internal/m;Lcom/google/firebase/remoteconfig/internal/f;Ljava/util/Set;LN5/c;Ljava/util/concurrent/ScheduledExecutorService;)V
    .locals 0
    ...
    iput-object p5, p0, Lcom/google/firebase/remoteconfig/internal/b;->e:LN5/c;
...
.method public static synthetic a(Lcom/google/firebase/remoteconfig/internal/b;Ll4/l;Ll4/l;JILl4/l;)Ll4/l;
    .locals 0

    invoke-direct/range {p0 .. p6}, Lcom/google/firebase/remoteconfig/internal/b;->h(Ll4/l;Ll4/l;JILl4/l;)Ll4/l;
...
.method private b(IJ)V
    ...
    sget-object p3, LN5/k$a;->G:LN5/k$a;

    invoke-direct {p1, p2, p3}, LN5/m;-><init>(Ljava/lang/String;LN5/k$a;)V

    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/internal/b;->k(LN5/k;)V
...
.method private declared-synchronized c(LN5/b;)V
    .locals 2
    ...
    invoke-interface {v1, p1}, LN5/c;->a(LN5/b;)V
    :try_end_0
...
.method private f(Ljava/io/InputStream;)V
    ...
    iget-object v4, p0, Lcom/google/firebase/remoteconfig/internal/b;->e:LN5/c;

    new-instance v5, LN5/m;

    const-string v6, "The server is temporarily unavailable. Try again in a few minutes."

    sget-object v7, LN5/k$a;->H:LN5/k$a;

    invoke-direct {v5, v6, v7}, LN5/m;-><init>(Ljava/lang/String;LN5/k$a;)V

    invoke-interface {v4, v5}, LN5/c;->b(LN5/k;)V
    ...
    sget-object v7, LN5/k$a;->F:LN5/k$a;

    const-string v8, "Unable to parse config update message."

    invoke-direct {v5, v8, v6, v7}, LN5/j;-><init>(Ljava/lang/String;Ljava/lang/Throwable;LN5/k$a;)V

    invoke-direct {p0, v5}, Lcom/google/firebase/remoteconfig/internal/b;->k(LN5/k;)V
...
.method private synthetic h(Ll4/l;Ll4/l;JILl4/l;)Ll4/l;
    .locals 2
    ...
    :cond_5
    invoke-static {p1}, LN5/b;->a(Ljava/util/Set;)LN5/b;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/firebase/remoteconfig/internal/b;->c(LN5/b;)V
...
.method private declared-synchronized k(LN5/k;)V
    .locals 2
...
# virtual methods
.method public declared-synchronized d(IJ)Ll4/l;
    .locals 9
    ...
    sget-object v2, Lcom/google/firebase/remoteconfig/internal/m$b;->E:Lcom/google/firebase/remoteconfig/internal/m$b;

    invoke-virtual {v1, v2, p1}, Lcom/google/firebase/remoteconfig/internal/m;->n(Lcom/google/firebase/remoteconfig/internal/m$b;I)Ll4/l;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/google/firebase/remoteconfig/internal/a;-><init>(Lcom/google/firebase/remoteconfig/internal/b;Ll4/l;Ll4/l;JI)V

    invoke-virtual {p1, v0, v8}, Ll4/l;->i(Ljava/util/concurrent/Executor;Ll4/c;)Ll4/l;
