...
.field private final f:LE4/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILE4/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:LE4/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {v1, v2}, LB1/i;->b(ZLjava/lang/Object;)V

    sget-object v1, Lm4/j;->n3:[I
    ...
    invoke-static {p0, p1, v1}, LB4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, LE4/k;->b(Landroid/content/Context;II)LE4/k$b;

    move-result-object p0

    invoke-virtual {p0}, LE4/k$b;->m()LE4/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILE4/k;Landroid/graphics/Rect;)V
...
.method c(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:LE4/k;

    invoke-virtual {v0, v2}, LE4/g;->setShapeAppearanceModel(LE4/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:LE4/k;

    invoke-virtual {v1, v2}, LE4/g;->setShapeAppearanceModel(LE4/k;)V
    ...
    invoke-virtual {v0, p2, v2}, LE4/g;->a0(FLandroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/X;->r0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
