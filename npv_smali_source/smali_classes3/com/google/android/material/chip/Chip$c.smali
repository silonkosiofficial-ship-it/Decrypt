...
.method constructor <init>(Lcom/google/android/material/chip/Chip;Lcom/google/android/material/chip/Chip;)V
    ...
    invoke-direct {p0, p2}, LJ1/a;-><init>(Landroid/view/View;)V
...
.method protected M(LC1/B;)V
    ...
    invoke-virtual {p1, v0}, LC1/B;->k0(Z)V
    ...
    invoke-virtual {p1, v0}, LC1/B;->n0(Z)V
    ...
    invoke-virtual {p1, v0}, LC1/B;->m0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, LC1/B;->S0(Ljava/lang/CharSequence;)V

    return-void
.end method

.method protected N(ILC1/B;)V
    .locals 5
    ...
    :goto_0
    invoke-virtual {p2, p1}, LC1/B;->q0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, LC1/B;->i0(Landroid/graphics/Rect;)V

    sget-object p1, LC1/B$a;->i:LC1/B$a;

    invoke-virtual {p2, p1}, LC1/B;->b(LC1/B$a;)V
    ...
    invoke-virtual {p2, p1}, LC1/B;->t0(Z)V

    goto :goto_2

    :cond_2
    invoke-virtual {p2, v1}, LC1/B;->q0(Ljava/lang/CharSequence;)V
