...
# instance fields
.field private final G:Landroidx/appcompat/widget/P;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, p3, v0}, LH4/a;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/v;->I:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lm4/j;->v2:[I
    ...
    invoke-static/range {v1 .. v6}, Lcom/google/android/material/internal/k;->i(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->K:F
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->H:Landroid/view/accessibility/AccessibilityManager;

    new-instance p3, Landroidx/appcompat/widget/P;

    invoke-direct {p3, p1}, Landroidx/appcompat/widget/P;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/google/android/material/textfield/v;->G:Landroidx/appcompat/widget/P;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/P;->J(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/P;->D(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/P;->I(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/P;->p(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/P;->L(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic b(Lcom/google/android/material/textfield/v;)Landroidx/appcompat/widget/P;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/textfield/v;->G:Landroidx/appcompat/widget/P;
...
.method private h()Z
    ...
    .prologue
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->H:Landroid/view/accessibility/AccessibilityManager;
...
.method private j()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/v;->G:Landroidx/appcompat/widget/P;

    invoke-virtual {v5}, Landroidx/appcompat/widget/P;->x()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->G:Landroidx/appcompat/widget/P;

    invoke-virtual {v0}, Landroidx/appcompat/widget/P;->h()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v2, p0, Lcom/google/android/material/textfield/v;->I:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/v;->I:Landroid/graphics/Rect;
...
.method public getPopupElevation()F
    ...
    iget v0, p0, Lcom/google/android/material/textfield/v;->K:F
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/v;->G:Landroidx/appcompat/widget/P;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/P;->p(Landroid/widget/ListAdapter;)V
...
.method public setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/P;->k(Landroid/graphics/drawable/Drawable;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/P;->M(Landroid/widget/AdapterView$OnItemSelectedListener;)V
...
.method public setSimpleItems([Ljava/lang/String;)V
    ...
    iget v2, p0, Lcom/google/android/material/textfield/v;->J:I
