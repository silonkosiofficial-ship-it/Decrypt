...
.method public g(Landroid/view/View;LC1/B;)V
    ...
    invoke-virtual {v8, p2}, Lcom/google/android/material/textfield/z;->A(LC1/B;)V

    const-string v8, ", "

    if-eqz v7, :cond_4

    invoke-virtual {p2, v0}, LC1/B;->S0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LC1/B;->S0(Ljava/lang/CharSequence;)V
    ...
    :goto_3
    invoke-virtual {p2, v3}, LC1/B;->S0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LC1/B;->y0(Ljava/lang/CharSequence;)V
    ...
    :goto_5
    invoke-virtual {p2, v6}, LC1/B;->P0(Z)V
    ...
    :goto_6
    invoke-virtual {p2, v4}, LC1/B;->D0(I)V
    ...
    :goto_7
    invoke-virtual {p2, v2}, LC1/B;->u0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v0}, LC1/B;->A0(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/material/textfield/s;->o(Landroid/view/View;LC1/B;)V
