...
.method public static final a(LO/b$a;)Lu0/d;
    ...
    invoke-virtual {v7, v4, v1}, Lu0/f;->h(FF)Lu0/f;

    const v5, 0x412970a4    # 10.59f

    invoke-virtual {v7, v5, v8}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v4, v3}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v3, v4}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v8, v5}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v1, v4}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v0, v3}, Lu0/f;->h(FF)Lu0/f;

    invoke-virtual {v7, v2, v8}, Lu0/f;->h(FF)Lu0/f;
