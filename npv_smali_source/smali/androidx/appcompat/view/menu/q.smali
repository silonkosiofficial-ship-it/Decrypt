...
.field final K:Landroidx/appcompat/widget/S;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroidx/appcompat/widget/S;

    const/4 p6, 0x0

    invoke-direct {p3, p1, p6, p4, p5}, Landroidx/appcompat/widget/S;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;
...
.method private z()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/P;->D(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;

    iget v3, p0, Landroidx/appcompat/view/menu/q;->V:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/P;->G(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/P;->F(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/P;->I(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/P;->H(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/P;->j()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/P;->p(Landroid/widget/ListAdapter;)V
...
.method public k(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;

    invoke-virtual {v2}, Landroidx/appcompat/widget/P;->c()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->K:Landroidx/appcompat/widget/S;

    invoke-virtual {v3}, Landroidx/appcompat/widget/P;->o()I
    ...
    invoke-static {v5}, Landroidx/core/view/X;->z(Landroid/view/View;)I
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/P;->e(I)V
