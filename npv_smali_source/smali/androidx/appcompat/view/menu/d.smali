...
.field a0:Landroid/view/ViewTreeObserver;

.field private b0:Landroid/widget/PopupWindow$OnDismissListener;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/d;->d0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->N:Landroidx/appcompat/widget/Q;
...
.method private F(Landroidx/appcompat/view/menu/g;)V
    ...
    sget v3, Landroidx/appcompat/view/menu/d;->d0:I
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->z()Landroidx/appcompat/widget/S;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/P;->p(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/P;->F(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->P:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/P;->G(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/S;->V(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/S;->S(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/P;->D(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/P;->e(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/P;->N(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/P;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/P;->e(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/P;->l(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/P;->H(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/d$d;-><init>(Landroidx/appcompat/widget/S;Landroidx/appcompat/view/menu/g;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->K:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/P;->b()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/P;->j()Landroid/widget/ListView;
...
.method private z()Landroidx/appcompat/widget/S;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/S;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->N:Landroidx/appcompat/widget/Q;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/S;->U(Landroidx/appcompat/widget/Q;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/P;->L(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/P;->K(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->Q:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/P;->D(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->P:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/P;->G(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/P;->J(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/P;->I(I)V
...
.method public a()Z
    ...
    iget-object v0, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;
...
.method public b()V
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->a0:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->a0:Landroid/view/ViewTreeObserver;
...
.method public c(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/d;->c0:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_2

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/S;->T(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/P;->E(I)V
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->a0:Landroid/view/ViewTreeObserver;
    ...
    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->a0:Landroid/view/ViewTreeObserver;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->b0:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;

    invoke-virtual {v3}, Landroidx/appcompat/widget/P;->a()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;

    invoke-virtual {v2}, Landroidx/appcompat/widget/P;->dismiss()V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/d$d;->a:Landroidx/appcompat/widget/S;

    invoke-virtual {v4}, Landroidx/appcompat/widget/P;->a()Z
...
.method public p(Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroidx/core/view/X;->z(Landroid/view/View;)I
...
.method public u(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->b0:Landroid/widget/PopupWindow$OnDismissListener;
