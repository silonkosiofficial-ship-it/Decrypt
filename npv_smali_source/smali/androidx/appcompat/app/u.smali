...
.field private static final h:Lr/Y;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/u;->h:Lr/Y;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v0, Landroidx/appcompat/app/u;->d:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/X;->o0(Landroid/view/View;Z)V

    :cond_1
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Landroidx/appcompat/app/u;->e:[I
    ...
    invoke-static {p2, v2}, Landroidx/core/view/X;->q0(Landroid/view/View;Ljava/lang/CharSequence;)V

    :cond_2
    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    sget-object v0, Landroidx/appcompat/app/u;->f:[I
    ...
    invoke-static {p2, p3}, Landroidx/core/view/X;->C0(Landroid/view/View;Z)V
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1}, Landroidx/core/view/X;->N(Landroid/view/View;)Z
    ...
    :cond_0
    sget-object v1, Landroidx/appcompat/app/u;->c:[I
...
.method private s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .prologue
    sget-object v0, Landroidx/appcompat/app/u;->h:Lr/Y;

    invoke-virtual {v0, p2}, Lr/Y;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p2, v1}, Lr/Y;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, Landroidx/appcompat/app/u;->a:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, Landroidx/appcompat/app/u;->g:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/u;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/u;->s(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, Landroidx/appcompat/app/u;->a:[Ljava/lang/Object;
...
.method public final r(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/u;->u(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/u;->q(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->d(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;

    move-result-object p5

    :goto_2
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/u;->v(Landroid/view/View;Ljava/lang/String;)V

    goto :goto_3

    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->g(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/l;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->e(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->c(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->i(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->p(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/H;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->k(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->n(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/A;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->m(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/y;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->h(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/p;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->o(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/D;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->j(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->f(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/u;->l(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/w;
    ...
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/u;->t(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
