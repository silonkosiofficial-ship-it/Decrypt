...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/p;->a:Lr/Y;

    new-instance v0, Lr/v;

    invoke-direct {v0}, Lr/v;-><init>()V

    iput-object v0, p0, Landroidx/recyclerview/widget/p;->b:Lr/v;
...
.method private l(Landroidx/recyclerview/widget/RecyclerView$D;I)Landroidx/recyclerview/widget/RecyclerView$m$b;
    ...
    .prologue
    iget-object v0, p0, Landroidx/recyclerview/widget/p;->a:Lr/Y;

    invoke-virtual {v0, p1}, Lr/Y;->d(Ljava/lang/Object;)I
    ...
    :cond_0
    iget-object v1, p0, Landroidx/recyclerview/widget/p;->a:Lr/Y;

    invoke-virtual {v1, p1}, Lr/Y;->k(I)Ljava/lang/Object;
...
.method c(JLandroidx/recyclerview/widget/RecyclerView$D;)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/p;->b:Lr/v;

    invoke-virtual {v0, p1, p2, p3}, Lr/v;->m(JLjava/lang/Object;)V
...
.method g(J)Landroidx/recyclerview/widget/RecyclerView$D;
    ...
    invoke-virtual {v0, p1, p2}, Lr/v;->e(J)Ljava/lang/Object;
...
.method m(Landroidx/recyclerview/widget/RecyclerView$D;)Landroidx/recyclerview/widget/RecyclerView$m$b;
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/p;->l(Landroidx/recyclerview/widget/RecyclerView$D;I)Landroidx/recyclerview/widget/RecyclerView$m$b;
...
.method o(Landroidx/recyclerview/widget/p$b;)V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/p;->a:Lr/Y;

    invoke-virtual {v2, v0}, Lr/Y;->h(I)Ljava/lang/Object;
    ...
    :goto_2
    invoke-interface {p1, v1, v3, v4}, Landroidx/recyclerview/widget/p$b;->c(Landroidx/recyclerview/widget/RecyclerView$D;Landroidx/recyclerview/widget/RecyclerView$m$b;Landroidx/recyclerview/widget/RecyclerView$m$b;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroidx/recyclerview/widget/p$b;->b(Landroidx/recyclerview/widget/RecyclerView$D;Landroidx/recyclerview/widget/RecyclerView$m$b;Landroidx/recyclerview/widget/RecyclerView$m$b;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroidx/recyclerview/widget/p$b;->d(Landroidx/recyclerview/widget/RecyclerView$D;Landroidx/recyclerview/widget/RecyclerView$m$b;Landroidx/recyclerview/widget/RecyclerView$m$b;)V
...
.method q(Landroidx/recyclerview/widget/RecyclerView$D;)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/p;->b:Lr/v;

    invoke-virtual {v1, v0}, Lr/v;->r(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lr/v;->p(I)V
    ...
    invoke-virtual {v0, p1}, Lr/Y;->remove(Ljava/lang/Object;)Ljava/lang/Object;
