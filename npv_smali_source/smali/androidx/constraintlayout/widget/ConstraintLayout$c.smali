...
.method public final b(Lr1/e;Ls1/b$a;)V
    .locals 19
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Lr1/e;->O()I
    ...
    invoke-virtual/range {p1 .. p1}, Lr1/e;->W()Z

    move-result v3

    if-nez v3, :cond_1

    iput v5, v2, Ls1/b$a;->e:I

    iput v5, v2, Ls1/b$a;->f:I

    iput v5, v2, Ls1/b$a;->g:I

    return-void

    :cond_1
    iget-object v3, v2, Ls1/b$a;->a:Lr1/e$b;

    iget-object v4, v2, Ls1/b$a;->b:Lr1/e$b;

    iget v6, v2, Ls1/b$a;->c:I

    iget v7, v2, Ls1/b$a;->d:I
    ...
    invoke-virtual/range {p1 .. p1}, Lr1/e;->q()Ljava/lang/Object;
    ...
    :goto_1
    iget-object v12, v1, Lr1/e;->h:[I

    const/16 v16, 0x0

    aput v16, v12, v5

    iget-boolean v13, v2, Ls1/b$a;->j:Z
    ...
    invoke-virtual/range {p1 .. p1}, Lr1/e;->z()I
    ...
    :goto_6
    iget-object v11, v1, Lr1/e;->h:[I

    const/4 v12, 0x0

    aput v12, v11, v15

    iget-boolean v12, v2, Ls1/b$a;->j:Z
    ...
    invoke-virtual/range {p1 .. p1}, Lr1/e;->N()I
    ...
    :goto_e
    sget-object v13, Lr1/e$b;->F:Lr1/e$b;
    ...
    sget-object v13, Lr1/e$b;->C:Lr1/e$b;
    ...
    iget-boolean v5, v2, Ls1/b$a;->j:Z

    if-nez v5, :cond_1d

    if-eqz v12, :cond_1d

    iget v5, v1, Lr1/e;->l:I

    if-nez v5, :cond_1d

    if-eqz v8, :cond_1d

    iget v5, v1, Lr1/e;->m:I
    ...
    invoke-virtual {v8, v5, v6, v11}, Landroidx/constraintlayout/widget/j;->n(Lr1/l;II)V
    ...
    :goto_21
    iput-boolean v6, v2, Ls1/b$a;->i:Z
    ...
    iput-boolean v1, v2, Ls1/b$a;->i:Z

    :cond_2f
    iput v0, v2, Ls1/b$a;->e:I

    iput v3, v2, Ls1/b$a;->f:I

    iput-boolean v9, v2, Ls1/b$a;->h:Z

    iput v4, v2, Ls1/b$a;->g:I
