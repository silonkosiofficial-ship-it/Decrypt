...
# direct methods
.method constructor <init>(Landroid/content/Context;Ly1/f;Landroidx/emoji2/text/k$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, LB1/i;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/k$b;->b:Ly1/f;
...
.method private e()Ly1/h$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/k$b;->b:Ly1/f;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/k$a;->b(Landroid/content/Context;Ly1/f;)Ly1/h$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Ly1/h$a;->c()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Ly1/h$a;->b()[Ly1/h$b;
...
.method c()V
    ...
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/k$b;->e()Ly1/h$b;

    move-result-object v0

    invoke-virtual {v0}, Ly1/h$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/k$a;->a(Landroid/content/Context;Ly1/h$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/k$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, Ly1/h$b;->d()Landroid/net/Uri;
