...
.method private a(Landroid/content/Context;Ly1/f;)Landroidx/emoji2/text/f$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/k;-><init>(Landroid/content/Context;Ly1/f;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Ly1/f;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, Ly1/f;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/f$c;
    ...
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/d$a;->h(Landroid/content/Context;)Ly1/f;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/d$a;->a(Landroid/content/Context;Ly1/f;)Landroidx/emoji2/text/f$c;
...
.method h(Landroid/content/Context;)Ly1/f;
    .locals 2
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/d$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Ly1/f;
