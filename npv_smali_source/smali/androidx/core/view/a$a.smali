...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)LC1/E;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, LC1/E;->e()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p1}, Landroidx/core/view/X;->U(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, LC1/B;->M0(Z)V

    invoke-static {p1}, Landroidx/core/view/X;->P(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, LC1/B;->x0(Z)V

    invoke-static {p1}, Landroidx/core/view/X;->o(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, LC1/B;->G0(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/X;->G(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, LC1/B;->R0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;LC1/B;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, LC1/B;->f(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LC1/B;->b(LC1/B$a;)V
