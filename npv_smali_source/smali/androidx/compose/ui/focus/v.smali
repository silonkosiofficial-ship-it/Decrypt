...
# direct methods
.method public static final synthetic a(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/focus/v;->r(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
...
.method private static final c(Ln0/i;Ln0/i;Ln0/i;I)Z
    .locals 4

    .prologue
    invoke-static {p2, p3, p0}, Landroidx/compose/ui/focus/v;->d(Ln0/i;ILn0/i;)Z
    ...
    invoke-static {p1, p3, p0}, Landroidx/compose/ui/focus/v;->d(Ln0/i;ILn0/i;)Z
    ...
    :cond_0
    invoke-static {p2, p3, p0}, Landroidx/compose/ui/focus/v;->e(Ln0/i;ILn0/i;)Z
    ...
    :cond_3
    invoke-static {p1, p3, p0}, Landroidx/compose/ui/focus/v;->f(Ln0/i;ILn0/i;)F

    move-result p1

    invoke-static {p2, p3, p0}, Landroidx/compose/ui/focus/v;->g(Ln0/i;ILn0/i;)F
...
.method private static final d(Ln0/i;ILn0/i;)Z
    .locals 4
...
.method private static final e(Ln0/i;ILn0/i;)Z
    .locals 4
...
.method private static final f(Ln0/i;ILn0/i;)F
    .locals 2
...
.method private static final g(Ln0/i;ILn0/i;)F
    .locals 2
...
.method private static final h(Ln0/i;)Ln0/i;
    .locals 4
...
.method private static final i(LF0/j;LX/b;)V
    .locals 10
    ...
    invoke-interface {v7}, Landroidx/compose/ui/focus/j;->p()Z

    move-result v7

    if-eqz v7, :cond_4

    invoke-virtual {p1, p0}, LX/b;->d(Ljava/lang/Object;)Z

    goto :goto_6

    :cond_4
    invoke-static {p0, p1}, Landroidx/compose/ui/focus/v;->i(LF0/j;LX/b;)V
...
.method private static final j(LX/b;Ln0/i;I)Landroidx/compose/ui/focus/FocusTargetNode;
    .locals 7
    ...
    :goto_0
    invoke-virtual {p1, v0, v2}, Ln0/i;->s(FF)Ln0/i;
    ...
    :goto_1
    invoke-virtual {p1, v2, v0}, Ln0/i;->s(FF)Ln0/i;
    ...
    invoke-static {v4}, Landroidx/compose/ui/focus/s;->d(Landroidx/compose/ui/focus/FocusTargetNode;)Ln0/i;

    move-result-object v5

    invoke-static {v5, v0, p1, p2}, Landroidx/compose/ui/focus/v;->m(Ln0/i;Ln0/i;Ln0/i;I)Z
...
.method public static final k(Landroidx/compose/ui/focus/FocusTargetNode;ILx7/l;)Z
    .locals 5
    ...
    invoke-static {p0, v0}, Landroidx/compose/ui/focus/v;->i(LF0/j;LX/b;)V
    ...
    invoke-static {p0}, Landroidx/compose/ui/focus/s;->d(Landroidx/compose/ui/focus/FocusTargetNode;)Ln0/i;

    move-result-object p0

    invoke-static {p0}, Landroidx/compose/ui/focus/v;->s(Ln0/i;)Ln0/i;
    ...
    invoke-static {p0}, Landroidx/compose/ui/focus/v;->h(Ln0/i;)Ln0/i;

    move-result-object p0

    :goto_3
    invoke-static {v0, p0, p1}, Landroidx/compose/ui/focus/v;->j(LX/b;Ln0/i;I)Landroidx/compose/ui/focus/FocusTargetNode;
...
.method private static final l(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Landroidx/compose/ui/focus/v$b;-><init>(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)V
...
.method private static final m(Ln0/i;Ln0/i;Ln0/i;I)Z
    .locals 5

    .prologue
    invoke-static {p0, p3, p2}, Landroidx/compose/ui/focus/v;->n(Ln0/i;ILn0/i;)Z
    ...
    :cond_0
    invoke-static {p1, p3, p2}, Landroidx/compose/ui/focus/v;->n(Ln0/i;ILn0/i;)Z
    ...
    :cond_1
    invoke-static {p2, p0, p1, p3}, Landroidx/compose/ui/focus/v;->c(Ln0/i;Ln0/i;Ln0/i;I)Z
    ...
    :cond_2
    invoke-static {p2, p1, p0, p3}, Landroidx/compose/ui/focus/v;->c(Ln0/i;Ln0/i;Ln0/i;I)Z
    ...
    :cond_3
    invoke-static {p3, p2, p0}, Landroidx/compose/ui/focus/v;->q(ILn0/i;Ln0/i;)J

    move-result-wide v3

    invoke-static {p3, p2, p1}, Landroidx/compose/ui/focus/v;->q(ILn0/i;Ln0/i;)J
...
.method private static final n(Ln0/i;ILn0/i;)Z
    .locals 4
...
.method private static final o(Ln0/i;ILn0/i;)F
    .locals 2
...
.method private static final p(Ln0/i;ILn0/i;)F
    .locals 4
...
.method private static final q(ILn0/i;Ln0/i;)J
    .locals 4

    invoke-static {p2, p0, p1}, Landroidx/compose/ui/focus/v;->o(Ln0/i;ILn0/i;)F
    ...
    invoke-static {p2, p0, p1}, Landroidx/compose/ui/focus/v;->p(Ln0/i;ILn0/i;)F
...
.method private static final r(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
    .locals 11
    ...
    invoke-static {v0, p1, p2}, Landroidx/compose/ui/focus/v;->j(LX/b;Ln0/i;I)Landroidx/compose/ui/focus/FocusTargetNode;
    ...
    invoke-interface {v1}, Landroidx/compose/ui/focus/j;->p()Z
    ...
    :cond_d
    invoke-static {p0, p1, p2, p3}, Landroidx/compose/ui/focus/v;->l(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
...
.method private static final s(Ln0/i;)Ln0/i;
    .locals 4
...
.method public static final t(Landroidx/compose/ui/focus/FocusTargetNode;ILn0/i;Lx7/l;)Ljava/lang/Boolean;
    .locals 8
    ...
    invoke-static {p0, p1, p3}, Landroidx/compose/ui/focus/v;->k(Landroidx/compose/ui/focus/FocusTargetNode;ILx7/l;)Z
    ...
    :cond_1
    invoke-static {p0, p2, p1, p3}, Landroidx/compose/ui/focus/v;->r(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
    ...
    :cond_7
    :goto_3
    invoke-static {p0, p2, p1, p3}, Landroidx/compose/ui/focus/v;->l(Landroidx/compose/ui/focus/FocusTargetNode;Ln0/i;ILx7/l;)Z
    ...
    :cond_8
    invoke-static {v0, p1, p2, p3}, Landroidx/compose/ui/focus/v;->t(Landroidx/compose/ui/focus/FocusTargetNode;ILn0/i;Lx7/l;)Ljava/lang/Boolean;
    ...
    invoke-static {p2}, Landroidx/compose/ui/focus/s;->d(Landroidx/compose/ui/focus/FocusTargetNode;)Ln0/i;
