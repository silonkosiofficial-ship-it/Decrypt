...
# direct methods
.method private constructor <init>(Landroidx/compose/foundation/lazy/layout/h;IJLD/M;)V
    .locals 0
    ...
    iput-object p5, p0, Landroidx/compose/foundation/lazy/layout/h$a;->c:LD/M;

    return-void
.end method

.method public synthetic constructor <init>(Landroidx/compose/foundation/lazy/layout/h;IJLD/M;Ly7/k;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Landroidx/compose/foundation/lazy/layout/h$a;-><init>(Landroidx/compose/foundation/lazy/layout/h;IJLD/M;)V
...
.method private final d()Z
    ...
    .prologue
    iget-object v0, p0, Landroidx/compose/foundation/lazy/layout/h$a;->d:LD0/i0$a;
...
.method private final e()Z
    ...
    invoke-static {v0}, Landroidx/compose/foundation/lazy/layout/h;->a(Landroidx/compose/foundation/lazy/layout/h;)LD/q;

    move-result-object v0

    invoke-virtual {v0}, LD/q;->d()Lx7/a;
...
.method private final f()V
    ...
    invoke-interface {v0, v1}, LD/s;->b(I)Ljava/lang/Object;

    move-result-object v1

    iget v2, p0, Landroidx/compose/foundation/lazy/layout/h$a;->a:I

    invoke-interface {v0, v2}, LD/s;->e(I)Ljava/lang/Object;

    move-result-object v0

    iget-object v2, p0, Landroidx/compose/foundation/lazy/layout/h$a;->j:Landroidx/compose/foundation/lazy/layout/h;

    invoke-static {v2}, Landroidx/compose/foundation/lazy/layout/h;->a(Landroidx/compose/foundation/lazy/layout/h;)LD/q;

    move-result-object v2

    iget v3, p0, Landroidx/compose/foundation/lazy/layout/h$a;->a:I

    invoke-virtual {v2, v3, v1, v0}, LD/q;->b(ILjava/lang/Object;Ljava/lang/Object;)Lx7/p;

    move-result-object v0

    iget-object v2, p0, Landroidx/compose/foundation/lazy/layout/h$a;->j:Landroidx/compose/foundation/lazy/layout/h;

    invoke-static {v2}, Landroidx/compose/foundation/lazy/layout/h;->b(Landroidx/compose/foundation/lazy/layout/h;)LD0/i0;

    move-result-object v2

    invoke-virtual {v2, v1, v0}, LD0/i0;->i(Ljava/lang/Object;Lx7/p;)LD0/i0$a;

    move-result-object v0

    iput-object v0, p0, Landroidx/compose/foundation/lazy/layout/h$a;->d:LD0/i0$a;
...
.method private final g(J)V
    ...
    iput-boolean v1, p0, Landroidx/compose/foundation/lazy/layout/h$a;->e:Z

    iget-object v0, p0, Landroidx/compose/foundation/lazy/layout/h$a;->d:LD0/i0$a;

    if-eqz v0, :cond_1

    invoke-interface {v0}, LD0/i0$a;->b()I
    ...
    invoke-interface {v0, v2, p1, p2}, LD0/i0$a;->g(IJ)V
...
.method private final h()Landroidx/compose/foundation/lazy/layout/h$a$a;
    ...
    invoke-direct {v2, v1}, Landroidx/compose/foundation/lazy/layout/h$a$b;-><init>(Ly7/O;)V

    const-string v3, "androidx.compose.foundation.lazy.layout.TraversablePrefetchStateNode"

    invoke-interface {v0, v3, v2}, LD0/i0$a;->f(Ljava/lang/Object;Lx7/l;)V
...
.method private final i(LD/O;J)Z
    .locals 4
...
.method public b(LD/O;)Z
    ...
    iget-object v2, p0, Landroidx/compose/foundation/lazy/layout/h$a;->c:LD/M;

    invoke-virtual {v2}, LD/M;->f()Lr/J;

    move-result-object v2

    invoke-virtual {v2, v0}, Lr/S;->a(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2, v0}, Lr/S;->c(Ljava/lang/Object;)J
    ...
    invoke-virtual {v2}, LD/M;->e()J

    move-result-wide v6

    :goto_0
    invoke-direct {p0, p1, v6, v7}, Landroidx/compose/foundation/lazy/layout/h$a;->i(LD/O;J)Z
    ...
    invoke-virtual {v6, v0, v3, v4}, Lr/S;->e(Ljava/lang/Object;J)J

    move-result-wide v6

    invoke-static {v2, v8, v9, v6, v7}, LD/M;->a(LD/M;JJ)J
    ...
    invoke-virtual {v10, v0, v6, v7}, Lr/J;->p(Ljava/lang/Object;J)V
    ...
    invoke-static {v2, v6, v7}, LD/M;->b(LD/M;J)V
    ...
    invoke-virtual {v2, p1}, Landroidx/compose/foundation/lazy/layout/h$a$a;->a(LD/O;)Z
    ...
    iget-object p1, p0, Landroidx/compose/foundation/lazy/layout/h$a;->c:LD/M;
    ...
    invoke-virtual {p1}, LD/M;->h()Lr/J;

    move-result-object v2

    invoke-virtual {v2, v0, v3, v4}, Lr/S;->e(Ljava/lang/Object;J)J

    move-result-wide v2

    invoke-static {p1, v7, v8, v2, v3}, LD/M;->a(LD/M;JJ)J
    ...
    invoke-virtual {v4, v0, v2, v3}, Lr/J;->p(Ljava/lang/Object;J)V

    :cond_a
    invoke-virtual {p1}, LD/M;->g()J
    ...
    invoke-static {p1, v2, v3}, LD/M;->c(LD/M;J)V
...
.method public cancel()V
    ...
    invoke-interface {v0}, LD0/i0$a;->e()V
