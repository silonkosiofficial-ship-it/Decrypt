...
.method public a(LW/e;LV/g;LV/k1;LV/Y0;)V
    ...
    :cond_0
    invoke-virtual {p3, v1}, LV/k1;->F(LV/d;)I

    move-result p2

    invoke-virtual {p3, p2, p1, v0}, LV/k1;->R0(IILjava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p3, p2, p1}, LV/k1;->a1(II)I
    ...
    invoke-virtual {v0}, LV/a1;->a()LV/d;
    ...
    invoke-virtual {p3, p1}, LV/k1;->F(LV/d;)I
    ...
    invoke-virtual {p3, p1}, LV/k1;->b1(I)I
    ...
    invoke-interface {p4, p3, v1, p1, p2}, LV/Y0;->a(LV/Z0;III)V

    goto :goto_1

    :cond_2
    instance-of p1, v0, LV/R0;

    if-eqz p1, :cond_3

    check-cast v0, LV/R0;

    invoke-virtual {v0}, LV/R0;->x()V
