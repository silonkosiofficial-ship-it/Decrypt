...
.method protected final n6(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1}, Ls3/H;->x(Ls3/W0;)V

    goto :goto_0

    :pswitch_2
    invoke-interface {p0}, Ls3/H;->i()V

    goto :goto_0

    :pswitch_3
    invoke-interface {p0}, Ls3/H;->c()V

    goto :goto_0

    :pswitch_4
    invoke-interface {p0}, Ls3/H;->j()V

    goto :goto_0

    :pswitch_5
    invoke-interface {p0}, Ls3/H;->h()V
    ...
    invoke-interface {p0, p1}, Ls3/H;->F(I)V

    goto :goto_0

    :pswitch_7
    invoke-interface {p0}, Ls3/H;->f()V
